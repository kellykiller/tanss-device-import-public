...
public sealed class TanssErpClient
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        using (document)
        {
            ...
            foreach (var companyElement in companyElements)
            {
                ...
                exactMatches.Add(ParseCompany(companyElement));
            }
        ...
        CancellationToken cancellationToken)
    {
        ...
        using (document)
        {
            ...
            var company = ParseCompany(contentElement);
    ...
    private static CompanyResult ParseCompany(JsonElement companyElement)
    {
        return new CompanyResult(
            Id: GetRequiredInt64(companyElement, "id"),
            CustomerNumber: GetRequiredTextValue(companyElement, "displayId"),
